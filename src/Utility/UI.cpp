...
const std::vector<std::string>& UI::GetExportOptions(std::shared_ptr<Resource> resource)
{
	...
	if (resourceTypeToExportOptions.empty())
	{
		...
		static std::vector<std::string> aibxExportOptions = { "Raw File (.AIBX)" };
		static std::vector<std::string> aibzExportOptions = { "Raw File (.AIBZ)" };
		static std::vector<std::string> airgExportOptions = { "Raw File (.AIRG)" };
		static std::vector<std::string> alocExportOptions = { "Raw File (.ALOC)" };
		static std::vector<std::string> asebExportOptions = { "Raw File (.ASEB)" };
		static std::vector<std::string> asetExportOptions = { "Raw File (.ASET)" };
		static std::vector<std::string> borgExportOptions = { "Raw File (.BORG)" };
		static std::vector<std::string> cbluExportOptions = { "Raw File (.CBLU)", "Json File (.JSON)" };
		static std::vector<std::string> clobExportOptions = { "Raw File (.CLOB)" };
		...
		static std::vector<std::string> eresExportOptions = { "Raw File (.ERES)" };
		static std::vector<std::string> fxacExportOptions = { "Raw File (.FXAC)" };
		static std::vector<std::string> fxasExportOptions = { "Raw File (.FXAS)" };
		...
		static std::vector<std::string> matbExportOptions = { "Raw File (.MATB)" };
		...
		static std::vector<std::string> mjbaExportOptions = { "Raw File (.MJBA)" };
		static std::vector<std::string> mrteExportOptions = { "Raw File (.MRTE)" };
		static std::vector<std::string> mrtnExportOptions = { "Raw File (.MRTN)" };
		static std::vector<std::string> mrtrExportOptions = { "Raw File (.MRTR)" };
		static std::vector<std::string> mucbExportOptions = { "Raw File (.MUCB)", "Json File (.JSON)" };
		static std::vector<std::string> muctExportOptions = { "Raw File (.MUCT)" };
		static std::vector<std::string> muscExportOptions = { "Raw File (.MUSC)" };
		static std::vector<std::string> nmshExportOptions = { "Raw File (.NMSH)" };
		static std::vector<std::string> pkglExportOptions = { "Raw File (.PKGL)", "Json File (.JSON)" };
		static std::vector<std::string> primExportOptions = { "Raw File (.PRIM)", "GLB File (.GLB)", "Folder (OBJ with MTL files)" };
		...
		resourceTypeToExportOptions.insert(std::make_pair('AIBX', aibxExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('AIBZ', aibzExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('AIRG', airgExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('ALOC', alocExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('ASEB', asebExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('ASET', asetExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('BORG', borgExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('CBLU', cbluExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('CLOB', clobExportOptions));
		...
		resourceTypeToExportOptions.insert(std::make_pair('CRMD', crmdExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('ChrT', chrtExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('ERES', eresExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('FXAC', fxacExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('FXAS', fxasExportOptions));
		...
		resourceTypeToExportOptions.insert(std::make_pair('MATB', matbExportOptions));
		...
		resourceTypeToExportOptions.insert(std::make_pair('MJBA', mjbaExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('MRTE', mrteExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('MRTN', mrtnExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('MRTR', mrtrExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('MUCB', mucbExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('MUCT', muctExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('MUSC', muscExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('NMSH', nmshExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('PKGL', pkglExportOptions));
		resourceTypeToExportOptions.insert(std::make_pair('PRIM', primExportOptions));
