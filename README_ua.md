...
Потужний десктопний редактор (написаний на C++23) для модифікації ігрових ресурсів **Hitman: Absolution**. Цей інструмент надає зручний інтерфейс для перегляду, експорту та модифікації ассетів гри безпосередньо з файлів рушія `.pc_reslib` та `.pc_headerlib`.
...
![Редагування локалізації](docs/images/image3.png)
![Редактор текстових списків](docs/images/image2.png)
![Редагування шрифтів SWF](docs/images/image1.png)
