...
static void DecodeOperandDX9(const BinaryDecompiler::Shader* psShader,
...
static void DeclareNumTemps(BinaryDecompiler::Shader* psShader,
...
static void SetupRegisterUsage(const BinaryDecompiler::Shader* psShader,
...
static void DeclareConstantBuffer(const BinaryDecompiler::Shader* psShader,
                                Declaration* psDecl)
{
...
static void DecodeDeclarationDX9(const BinaryDecompiler::Shader* psShader,
                                const uint32_t ui32Token0,
                                const uint32_t ui32Token1,
                                Declaration* psDecl)
{
...
static void DefineDX9(BinaryDecompiler::Shader* psShader,
...
BinaryDecompiler::Shader* DecodeDX9BC(const uint32_t* pui32Tokens)
{
    ...
    BinaryDecompiler::Shader* psShader = new BinaryDecompiler::Shader();
