...
static const uint32_t* ReadConstantBuffer(ShaderInfo* psShaderInfo,
    const uint32_t* pui32FirstConstBufToken, const uint32_t* pui32Tokens, BinaryDecompiler::ConstantBuffer* psBuffer)
{
    uint32_t i;
    uint32_t ui32NameOffset = *pui32Tokens++;
                   ...
                   ShaderInfo* psShaderInfo)//out
{
	...
	BinaryDecompiler::ConstantBuffer* psConstantBuffers;
    ...
    psConstantBuffers = new BinaryDecompiler::ConstantBuffer[ui32NumConstantBuffers];
...
void GetConstantBufferFromBindingPoint(const ResourceGroup eGroup, const uint32_t ui32BindPoint, const ShaderInfo* psShaderInfo, BinaryDecompiler::ConstantBuffer** ppsConstBuf)
{
...
{
    uint32_t i;
	BinaryDecompiler::ConstantBuffer* psThisPointerConstBuffer = psShaderInfo->psThisPointerConstBuffer;
...
int GetShaderVarFromOffset(const uint32_t ui32Vec4Offset,
						   ...
						   BinaryDecompiler::ConstantBuffer* psCBuf,
						   ShaderVarType** ppsShaderVar,
						   int32_t* pi32Index,
						   int32_t* pi32Rebase)
{
    ...
    ShaderInfo* psInfo)
{
	...
	BinaryDecompiler::ConstantBuffer* psConstantBuffer;
    ...
    psConstantBuffer = new BinaryDecompiler::ConstantBuffer[1];
